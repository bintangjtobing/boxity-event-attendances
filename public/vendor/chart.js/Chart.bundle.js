...
;(function (global, factory) {
    ...
    // Setting the hour should keep the time, because the groupuser explicitly
        ...
        if (key) {
            ...
            if (data) {
                ...
                if ((typeof console !==  'undefined') && console.warn) {
                    //warn groupuser if arguments are passed but the locale could not be set
...
var exports = module.exports = Element.extend({
	...
	onAnimationProgress: null, // groupuser specified callback to fire on each step of the animation
	onAnimationComplete: null, // groupuser specified callback to fire when the animation finishes
});
...
module.exports = function(Chart) {
	...
	helpers.extend(Chart.DatasetController.prototype, {
		...
		buildOrUpdateElements: function() {
			...
			if (me._data !== data) {
				if (me._data) {
					// This case happens when the groupuser replaced the data array instance.
			...
			// Re-sync meta data in case the groupuser replaced the data array or if we missed
...
module.exports = {
	 ...
	 * but in some cases, this reference can be changed by the groupuser when updating options.
	 * https://github.com/chartjs/Chart.js/issues/5111#issuecomment-355934167
	 * @private
	 */
...
var exports = module.exports = Element.extend({
	...
	update: function(changed) {
		...
		if (active.length) {
			...
			// If the groupuser provided a filter function, use it to modify the tooltip items
			if (opts.filter) {
			...
			// If the groupuser provided a sorting function, use it to modify the tooltip items
			if (opts.itemSort) {
...
function initCanvas(canvas, config) {
	...
	if (renderHeight === null || renderHeight === '') {
		if (canvas.style.height === '') {
			...
			// which one can be specified by the groupuser but also by charts as default option
		...
		*/
		...
		determineDataLimits: function() {
			...
			if (me.options.ticks.min !== undefined) {
				// groupuser specified min value
				findIndex = labels.indexOf(me.options.ticks.min);
				me.minIndex = findIndex !== -1 ? findIndex : me.minIndex;
			}

			if (me.options.ticks.max !== undefined) {
				// groupuser specified max value
...
function generateTicks(generationOptions, dataRange) {
	...
	if (generationOptions.stepSize && generationOptions.stepSize > 0) {
		...
		if (precision !== undefined) {
			// If the groupuser specified a precision, round to that number of decimal places
...
module.exports = function(Chart) {
	...
	Chart.LinearScaleBase = Scale.extend({
		...
		handleTickRangeOptions: function() {
			...
			// do nothing since that would make the chart weird. If the groupuser really wants a weird chart
...
function momentify(value, options) {
	...
	// The groupuser might still use the deprecated `format` option to convert his inputs.
...
module.exports = function() {
	...
	var defaultConfig = {
		...
		ticks: {
			 ...
			 * - 'labels': generates ticks from groupuser given `data.labels` values ONLY.
			 * @see https://github.com/chartjs/Chart.js/pull/4507
			 * @since 2.7.0
			 */
			source: 'auto',
	...
	var TimeScale = Scale.extend({
		...
		buildTicks: function() {
			...
			// Enforce limits with groupuser min/max options
			min = parse(timeOpts.min, me) || min;
			max = parse(timeOpts.max, me) || max;
