...
<head>
    ...
    <title>Boxity | Event Inactive</title>
                ...
                <div class="col-12">
                    ...
                    <div class="min-vh-100 content-center">
                        <div class="error-page text-center">
                            ...
                            <div class="error-page__title">We are sorry, Event inactive!</div>
                            <h5 class="fw-500">
                                THE EVENT YOU ARE LOOKING FOR MIGHT HAVE BEEN INACTIVE HAD ITS NOT STARTED OR ENDED.
                            </h5>
