                            ...
                            <form id="formEdit">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15"
                                        id="formGroupExampleInput" name="name" value="{{ $admin->name }}">
                                </div>
                                <div class="form-group">
                                    <label for="formGroupExampleInput"
                                        class="color-dark fs-14 fw-500 align-center">Username</label>
                                    <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15"
                                        id="formGroupExampleInput" name="username" value="{{ $admin->username }}">
                                </div>
                                <div class="form-group">
                                    <label for="formGroupExampleInput"
                                    ...
                                    <input type="email" class="form-control ih-medium ip-gray radius-xs b-light px-15"
                                        id="formGroupExampleInput" name="email" value="{{ $admin->email }}">
                                </div>
                                <div class="form-group">
                                    <label for="formGroupExampleInput"
                                        class="color-dark fs-14 fw-500 align-center">Role</label>
                                    <div class="atbd-select ">
                                        <select name="role_id" id="select-search" class="form-control ">
                                            @foreach ($roles as $item)
                                                <option value="{{ $item->id }}"
                                                    @if ($item->id == $admin->role_id) selected @endif>
                                                    {{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="layout-button mt-25">
                                    <button type="button"
                                        ...
                                        onclick="window.location.href='{{ route('admin_view_index') }}';">back</button>
                                    <button type="submit"
