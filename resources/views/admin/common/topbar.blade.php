<nav class="navbar navbar-light">
    <div class="navbar-left">
        ...
        <a class="navbar-brand" href="#"><img class="dark" src="{{ asset('brand/logo primary.png') }}"
                alt="svg"><img class="light" src="{{ asset('brand/logo secondary.png') }}" alt="img"></a>
        {{-- <form action="{{ route('dashboard_view_admin') }}" class="search-form">
                ...
                <ul>
                    <li class="has-subMenu">
                        ...
                        <ul class="subMenu">
                            ...
                            <li>
                                <a class="active" href="sales.html">
                                    Sales Performance</a>
                            </li>
                        </ul>
                    </li>
    ...
    <div class="navbar-right">
        <ul class="navbar-right__menu">
            ...
            <li class="nav-author">
                <div class="dropdown-custom">
                    <a href="javascript:;" class="nav-item-toggle"><img src="{{ asset('brand/profile.png') }}"
                            alt="" class="rounded-circle"></a>
                    <div class="dropdown-wrapper">
                        <div class="nav-author__info">
                            ...
                            <div class="author-img">
                                <img src="{{ asset('brand/profile.png') }}" alt="" class="rounded-circle">
                            </div>
                            <div>
                                <h6>{{ $user->name }}</h6>
                        ...
                        <div class="nav-author__options">
                            ...
                            <a href="{{ route('admin_logout') }}" class="nav-author__signout">
